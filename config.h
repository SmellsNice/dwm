...
static const Key keys[] = {
	...
	{ MODKEY,			XK_KP_Subtract,      spawn,                  SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_KP_Subtract,      spawn,                  SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 15%-; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_KP_Add,     spawn,                  SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_KP_Add,     spawn,                  SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 15%+; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY,			XK_idotless,   setlayout,              {.v = &layouts[6]} }, /* centeredmaster */
	{ MODKEY|ShiftMask,		XK_idotless,   setlayout,              {.v = &layouts[7]} }, /* centeredfloatingmaster */
	...
	{ MODKEY|ShiftMask,		XK_d,          spawn,                  SHCMD("clipctl disable; passmenu -i; clipctl enable") },
	...
	{ MODKEY,			XK_F5,         spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "nyaa", NULL } } },
	{ MODKEY,			XK_F6,         spawn,                  {.v = (const char*[]){ "torwrap", NULL } } },
	{ MODKEY,			XK_F7,         spawn,                  {.v = (const char*[]){ "td-toggle", NULL } } },
	{ MODKEY,			XK_F8,         spawn,                  {.v = (const char*[]){ "mailup", NULL } } },
